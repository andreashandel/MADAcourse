...
You briefly encountered Tidy Tuesday before in the [Data Analysis Motivation unit](../modules/Data_Analysis_Motivation.qmd). If you can't remember, revisit that unit and re-read that section. Also read the information at the provided links. 
