...
*A great project would be at the level of Brian McKay's paper example you checked out in the [Motivating Examples document](../modules/data_analysis/Data_Analysis_Motivation.qmd), or one of the projects on the `Project Examples` page.*
