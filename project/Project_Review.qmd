...
Follow the instructions provided in the repository to run all code and reproduce everything. Review the whole project using [this review template](https://raw.githubusercontent.com/andreashandel/MADAcourse/master/docs/templatefiles/Project_Review_Template.qmd) (right-klick to download). \* Write up a detailed review using and filling out the template. Once you are done, place your completed review document into the repository you are reviewing, and send a pull request (or do a direct push) for each project you review.
