...
-   We will use [Git](https://git-scm.com/) and [GitHub](https://github.com/) for exercises and the project.
...
Modeling and Data Science Tools](https://andreashandel.github.io/mds-tools/).


As preparation for MADA and the first assignment, go through the **Positron**, **R**, **Quarto**, **Git/GitHub** and **AI** tutorials on that site. The **Portfolio** tutorial will be your first exercise.
