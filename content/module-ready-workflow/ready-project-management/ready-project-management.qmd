...
Git/GitHub is a very common method of working collaboratively on projects. We covered it previously. The following only mentions (again) some topics worth keeping in mind when using Git/GitHub for data analysis work.
