...
knitr::read_chunk('synthetic-data-model-testing-R.R')
knitr::read_chunk('synthetic-data-model-testing-R2.R')
```
...
Here's code to do that (you can again find [the full R script here](synthetic-data-model-testing-R.R)).
