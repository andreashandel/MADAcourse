...
AI tools are very useful for generating synthetic data. In fact, the code in the examples below was partially generated through back and forth with ChatGPT, together with some manual editing. 
...
We'll walk slowly through the code chunks, you can find [all the code in this file](synthetic-data-new-R-example-2-code.R).
