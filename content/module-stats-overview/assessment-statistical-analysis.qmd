...
You don't need to go into modeling details, a big picture description is enough. For instance if the authors clearly did a secondary analysis collected for a different purpose, but present their findings as if they had a fully pre-specified hypothesis and analysis protocol (e.g., they use p-values and talk about 'significance'), point out this mis-representation (there's no shortage of studies like that).
