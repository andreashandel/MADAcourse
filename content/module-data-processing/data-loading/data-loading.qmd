...
-   The [`readr` package](https://readr.tidyverse.org/index.html) is great first choice for importing CSV and similar spreadsheet type data. For some more introductory material on the `readr` package, see [chapter 11 of *R4DS*](https://r4ds.hadley.nz/data-import.html). It can often guess the right way to import data, even if it is slightly messy. But always check! It's a good first choice for CSV/TSV/text style data.
...
To learn some more, you can check out the [Importing Data chapter in *IDS*](https://rafalab.github.io/dsbook/importing-data.html). The [Web Scraping chapter in *IDS*](https://rafalab.github.io/dsbook/web-scraping.html) provides additional information on how to pull online data into R.
...
::: container
<iframe class="video" src="https://www.youtube.com/embed/z7pOxe6dDG0" frameborder="0" allowfullscreen></iframe>
:::

::: container
<iframe class="video" src="https://www.youtube.com/embed/7lE7lzwC_NY" frameborder="0" allowfullscreen></iframe>
:::
