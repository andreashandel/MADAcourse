...
2.  Once you understand the data sufficiently, formulate a
    ...
    the data will be. If it turns out that the data just doesn't easily work for asking a question, create some synthetic data/variables to augment the existing data such that it will be possible to ask a question and do some machine learning modeling.
...
You've added most "products" you generated as part of this class to the portfolio website. If you
