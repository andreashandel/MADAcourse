...
For scientific data, the discrete pieces of data/information (e.g., gender and age) are usually referred to as variables. A variable is essentially measurements of one quantity, and data is generally made up of collections of variables.

As such, variables form the basic building blocks of a lot of data. Different types of variables exist, and depending on the type, the analysis will be different. The main categories are 
