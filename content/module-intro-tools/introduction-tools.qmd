...
-   We will use Positron (an editor and graphical frontend to R). You can use a different editor if you want (e.g. RStudio), but the instructions assume you are using Positron.
