...
We'll practice a bit of model fitting using the `tidymodels` framework. Of course, some data processing and EDA components are also needed. This is another solo exercise. 


## Setup

This will be part of your portfolio site. Place all files inside the 
