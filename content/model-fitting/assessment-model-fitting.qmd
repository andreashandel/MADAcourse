...
::: instruction
Write code to load the data into R and make such a figure.
:::
...
::: instruction
Write code that converts `RACE` and `SEX` to factor variables and keeps only these variables: Y,DOSE,RATE,AGE,SEX,RACE,WT,HT
:::
...
Interpret the results and add additional comments and thoughts to the document, so a reader can understand what you did, why you did it, and what it all means. 
