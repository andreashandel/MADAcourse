...
[Advanced Data Science](http://rafalab.dfci.harvard.edu/dsbook-part-2/) -- which used to be part of the old IDS -- has a chapter on it. [ISLR](https://statlearning.com/) also has a chapter on the topic. So does [HMLR](https://bradleyboehmke.github.io/HOML/).
