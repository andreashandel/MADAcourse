...
[Chapter 2 *ISL*](https://statlearning.com/) covers the bias-variance trade-off. 
...
```{r model-performance-revisited-quiz}
#| echo: false
#| results: "asis"
quizzes <- list(
  "model-performance-revisited-quiz-1.Rmd",
  "model-performance-revisited-quiz-2.Rmd",
  "model-performance-revisited-quiz-3.Rmd"
)
exams2forms::exams2forms(
  file = quizzes,
  title = "model-performance-revisited-quiz"
)
```
:::
<!-- end unit-quiz div -->
