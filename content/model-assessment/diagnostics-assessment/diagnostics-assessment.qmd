...
```{r diagnostics-assessment-quiz}
#| echo: false
#| results: "asis"
quizzes <- list("diagnostics-assessment-quiz-1.Rmd", "diagnostics-assessment-quiz-2.Rmd", "diagnostics-assessment-quiz-3.Rmd")
exams2forms::exams2forms( file = quizzes, title = "diagnostics-assessment-quiz")
```
:::
