...
```{r external-data-assessment-quiz}
#| echo: false
#| results: "asis"
quizzes <- list(
  "external-data-assessment-quiz-1.Rmd",
  "external-data-assessment-quiz-2.Rmd",
  "external-data-assessment-quiz-3.Rmd"
)
exams2forms::exams2forms(
  file = quizzes,
  title = "external-data-assessment-quiz"
)
```
:::
<!-- end unit-quiz div -->
