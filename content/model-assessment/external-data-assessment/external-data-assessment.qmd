---
title: "External data based model assessment"
...
![Source: [Cross Validation Wikipedia Page](https://en.wikipedia.org/wiki/Cross-validation_(statistics))](../../media/cross_validation.jpg){fig-alt="A schematic showing data represented as green and red circles, with some data labeled test data and some training data. Each row shows the data, with always a different portion of the training data being separated, as indicated by a box. The data outside the box is used for model training, the data inside the box is used for the cross-validation."}
