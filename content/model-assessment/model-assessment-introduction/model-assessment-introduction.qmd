...
q1 <- "You should always choose the model that provides the best performance."
q2 <- "Which of the following is fairly unimportant when assessing models?"
q3 <- "You need to use your expert knowledge as part of model assessment."

# Define the answer choices
q2_choices <- c("Model performance", "Model complexity", answer= "Model programming language",  "Model uncertainty")


cat(q2,webexercises::longmcq(q2_choices))
