...
```{r model-assessment-introduction-quiz}
#| echo: false
#| results: "asis"
quizzes <- list(
  "model-assessment-introduction-quiz-1.Rmd",
  "model-assessment-introduction-quiz-2.Rmd",
  "model-assessment-introduction-quiz-3.Rmd"
)
exams2forms::exams2forms(
  file = quizzes,
  title = "model-assessment-introduction-quiz"
)
```
:::
<!-- end unit-quiz div -->
