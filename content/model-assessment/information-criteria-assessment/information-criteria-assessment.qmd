...
```{r information-criteria-assessment-quiz}
#| echo: false
#| results: "asis"
quizzes <- list(
  "information-criteria-assessment-quiz-1.Rmd",
  "information-criteria-assessment-quiz-2.Rmd",
  "information-criteria-assessment-quiz-3.Rmd"
)
exams2forms::exams2forms(
  file = quizzes,
  title = "information-criteria-assessment-quiz"
)
```
:::
<!-- end unit-quiz div -->
