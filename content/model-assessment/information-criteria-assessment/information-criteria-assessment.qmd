...
q1 <- "Information criteria provide estimates of model performance on new data that are as good as those obtained from a train/test approach."
q2 <- "You should try many different information criteria and choose the one which gives the best results."
q3 <- "Which of the following is NOT a common information criterion?"

# Define the answer choices
q3_choices <- c(answer= "VIC", "BIC", "DIC",  "AIC")
