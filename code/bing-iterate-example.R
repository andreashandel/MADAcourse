...
#Make a figure that shows weight on the x-axis, BMI on the y-axis, and
#stratification by sex. Add thorough documentation to the code.
...
data <- data.frame(
  ...
  weight = runif(100, min = 100, max = 500),
