...
One useful thing to know is that people will get a specific notification if you either send them a direct message or use their handle in our message, e.g. by writing _@personname can you take a look at the figure below..._. Specifically, if you want to get my attention, you need to do it that way. I have too many things pinging me all the time 😁. While I try to stay on top of all the messages in our class, I likely won't. To ensure I don't miss something directed at me, use the @ notation (or DM).
