...
For each module, you are asked to fill out an Excel sheet with questions related to the course material. Download the quiz files from the links below, fill in the `Answer` column, and submit to the online quiz submission system by the deadline specified in the [**Schedule**](course-schedule.qmd) document.
...
* [Module 1 – Course and tools introduction](/assets/quizsheets/m1_mada_course_tools_student.xlsx) - you have 2 attempts available for this one.
* [Module 2 – Data analysis introduction ](/assets/quizsheets/m2_mada_data_analysis_intro_student.xlsx)
<!-- * [Module 3 – READy Workflow](/assets/quizsheets/m3_mada_ready_workflow_student.xlsx)
* [Module 4 – All about data](/assets/quizsheets/m4_mada_data_student.xlsx)
* [Module 5 – Data Processing](/assets/quizsheets/m5_mada_data_processing_student.xlsx)
* [Module 6 – Data presentation](/assets/quizsheets/m6_mada_presentation_student.xlsx)
* [Module 7 – Statistical Analysis Overview](/assets/quizsheets/m7_mada_statistical_analysis_overview_student.xlsx)
* [Module 8 – Fitting basic statistical models](/assets/quizsheets/m8_mada_model_fitting_student.xlsx)
* [Module 9 – Evaluating your model fits](/assets/quizsheets/m9_mada_model_assessment_student.xlsx)
* [Module 10 – Improving your model fits](/assets/quizsheets/m10_mada_model_improvement_student.xlsx)
* [Module 11 – Machine Learning Models I](/assets/quizsheets/m11_mada_ml_models_1_student.xlsx)
* [Module 12 – Machine Learning Models II](/assets/quizsheets/m12_mada_ml_models_2_student.xlsx)
* [Module 13 – The complete analysis workflow](/assets/quizsheets/m13_mada_full_workflow_student.xlsx) -->
...
See the [**Projects**](../project/project-Overview.qmd) section on the website for more information.
