...
The *Assessments* column lists items that need to be submitted and that will be graded.
...
::: emphasis
Unless otherwise specified, the first posting of the discussion is due by end of Wednesday, the discussion replies are due by end of Friday.
Quizzes are due by Friday.
Exercises often have multiple parts with staggered deadlines.
See each exercise for details.
:::

| **Module Topic** | **Start and end dates** | Quiz | Exercise | **Discussion** |
|-------------------------|----------------|--|--|-----------------------------|
| Module 1 -- Course and tools introduction | 1/6 -- 1/10 | Y | Portfolio start | Introductions |
| Module 2 -- Data analysis introduction | 1/13 -- 1/17 | Y |  | quiz, exercise, discussion |
| Module 3 -- R coding basics | 1/20 -- 1/24 | Y |  | quiz, exercise, discussion |
| Module 4 -- All about data | 1/27 -- 1/31 | Y |  | quiz, exercise, **project part 1** |
| Module 5 -- Data processing | 2/3 -- 2/7 | Y |  | quiz, exercise, discussion |
| Module 6 -- Presenting data | 2/10 -- 2/14 | Y |  | quiz, exercise, discussion |
| Module 7 -- Statistical analysis overview | 2/17 -- 2/21 | Y |  | quiz, discussion, **project part 2** |
| Module 8 -- Model fitting | 2/24 -- 2/28 | Y |  | quiz, exercise, discussion |
| **Spring Break** | **3/3 -- 3/7** |  |  |  |
| Module 9 -- Model assessment | 3/10 -- 3/14 | Y |  | quiz, discussion, **project part 3** |
| Module 10 -- Model improvement | 3/17 -- 3/21 | Y |  | quiz, exercise, project part 3 review |
| Module 11 -- Machine learning models I | 3/24 -- 3/28 | Y |  | quiz, exercise, discussion |
| Module 12 -- Machine learning models II | 3/31 -- 4/4 | Y |  | quiz, discussion, **project part 4** |
| Module 13 -- The complete analysis workflow | 4/7 -- 4/11 | Y |  | quiz, exercise, discussion |
