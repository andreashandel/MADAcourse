...
* Here is another example and template of setting up a website with [Quarto](https://www.marvinschmitt.com/blog/website-tutorial-quarto/), similar to what you are asked to do for the [Introductory Exercise](../modules/intro_tools/Assessment_Course_Tools_Introduction.qmd).
