...
* [NHANES](https://www.cdc.gov/nchs/nhanes/index.html) - longstanding and thorough survey done by CDC
...
* [medicaldata R package](https://higgi13425.github.io/medicaldata/) - contains several medical datasets that can be used to practice data analysis. The website also contains links to a few messy (kinda real world) data sets.
