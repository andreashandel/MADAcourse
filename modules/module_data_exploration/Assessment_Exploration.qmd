...
Get the quiz sheet for this module from the general [__Assessments__](../../courseinfo/Course_Assessments.qmd) page. Fill it in, then submit to the online grading system before the deadline. 
...
You briefly encountered Tidy Tuesday before in the [Data Analysis Motivation unit](../module_data_analysis/Data_Analysis_Motivation.qmd). If you can't remember, revisit that unit and re-read that section. Also read the information at the provided links. 
