...
This short summary closely followed the information in the [Moving Beyond Linearity chapter of *ISL*](https://statlearning.com/). Check out that chapter for further information on the models covered here, as well as a few additional variations. HMLR also discusses several models of this type. See for instance the [Multivariate Adaptive Regression Splines chapter of *HMLR*](https://bradleyboehmke.github.io/HOML/mars.html). The [Smoothing chapter of *IDS*](https://rafalab.github.io/dsbook/smoothing.html) also covers the topic discussed here. For specific ways of using some of these models through `tidymodels`, check out some of the tutorials in the [`tidymodels` "learn" section](https://www.tidymodels.org/learn/).
