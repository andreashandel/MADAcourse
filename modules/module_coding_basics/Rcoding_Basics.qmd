...
::: note
There are two ways of assigning something to an object in R, one
...
Asking AI for help can often faster and more efficient than trying to find the answer via Google/StackOverflow. So make use of AI tools to help you get to working code quickly.
