...
# Overview
In this tutorial, we discuss why you might want to create synthetic (simulated/artificial/fake) data as part of your analysis and what general approaches there are for doing so.
...
- Make it all up
- Generate data following distributions obtained from the original data
- Scramble of the original data
