---
title: Generating synthetic data based on existing data - R
subtitle: ""
---
...
You probably don't want to feed your real data to the AI. So the first part of summarizing existing data has to be done in a safe/secure space. Once you have good data summaries, you can use AI to generate synthetic data and code as shown in the previous tutorial.
...
Now we'll create synthetic data that is similar to the real data.
...
There are a number of R packages that can let you generate data more easily. We'll look at some in another tutorial. But it's always good to be able to do it yourself, in case you end up in a situation where the available packages can't get you what you need.
