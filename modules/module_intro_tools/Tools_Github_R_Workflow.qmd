...
I assume you read through the [Git/GitHub introduction](../module_intro_tools/Tools_Github_Introduction.qmd) and have created a GitHub account.
...
![](../../media/newrepo.png){width="60%" fig-align="center" fig-alt="Screenshot of GitHub on the 'Create a new repository' page. The new repository is named 'mynewrepository', set to Public, and the boxes are checked for 'Add a README file' and 'Add .gitignore' with the .gitignore template set to R."}
...
![](../../media/newproject.png){width="60%" fig-alt="center" fig-alt="Screenshot of RStudio New Project Wizard with the directory named 'mynewproject' and the 'Create a git repository' checkbox marked."}
