...
Each module comes with assessments. Those are things you need to do that will be graded. The table on the [**Schedule**](../../courseinfo/Course_Schedule.qmd) page lists the assessments for each module.

If you haven't done so, please read through the [**Assessments Overview**](../../courseinfo/Course_Assessments.qmd) page so you know how each type of assessment should be done and how grading works.
...
**For this part of the task, the [comprehensive Quarto guide](https://quarto.org/docs/guide/) and [the Quarto section of the work-in-progress 2nd edition of *R for Data Science*](https://r4ds.hadley.nz/quarto.html) will likely be useful.**
