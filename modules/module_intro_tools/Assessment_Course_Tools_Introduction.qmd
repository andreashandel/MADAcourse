...
Each module comes with an assessment. Those are things you need to do that will be graded. The table on the [**Schedule**](../../courseinfo/Course_Schedule.qmd) page lists the assessments for each module.

If you haven't done so, please read through the [**Assessments**](../../courseinfo/Course_Assessments.qmd) page so you know how each type of assessment should be done and how it's graded.
