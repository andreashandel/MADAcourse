...
For more detailed learning objectives, see the [**Syllabus**](../../courseinfo/Course_Syllabus.qmd).
...
-   The course is split into modules. Each module will usually be covered in a week. The [**Schedule**](../../courseinfo/Course_Syllabus.qmd) document gives an outline. The schedule is not fully finalized and will change, so check frequently.
...
For details on assessments, see the [**Assessments**](../../courseinfo/Course_Assessments.qmd) page.

## Course Resources

We'll be drawing on a lot of different resources. I compiled a list with the ones we'll use and others you might find helpful in the [**Resources**](../../resources/Course_Resources.qmd) section of the class website.

## Getting help

I do not expect you to figure it all out yourselves. You will get stuck and are encouraged to seek help. You can ask for help from your classmates or your instructor. Also, use the wider community online. For specific places to get help, see the [**Resources**](../../resources/Course_Resources.qmd) pages.
