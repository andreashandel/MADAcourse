...
In addition to the sources mentioned above, other good reads are the [*Judging model effectiveness*](https://www.tmwr.org/performance.html) and [*When should you trust your predictions?*](https://www.tmwr.org/trust.html) chapters of TMWR.
