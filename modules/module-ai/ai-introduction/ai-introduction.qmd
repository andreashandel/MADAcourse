...
# Introduction
Artificial intelligence (AI) is everywhere these days. AI approaches have led to some impressive recent technological advances, such as self-driving cars, very good language translation, biometrics and image recognition, computers that beat humans at games like Chess/Go/Poker, etc. Most recently, we have seen LLM AI tools (which we'll discuss separately) that can be very useful for doing data analysis and coding tasks.
