...
# Overview
In this unit, we will **very** briefly talk about the topics of Artificial Intelligence and Deep Learning.
...
If you want to learn more about neural nets, the [Wikipedia entry](https://en.wikipedia.org/wiki/Artificial_neural_network) is a good place to start. The [Deep Learning Chapter of *HMLR*](https://bradleyboehmke.github.io/HOML/deep-learning.html) also provides a nice introduction.
...
For some additional/complementary material, see these [materials from a recent workshop by Phil Bowsher](https://github.com/philbowsher/Workshop-R-Tensorflow-Scientific-Computing) that also describes doing deep learning in R.
