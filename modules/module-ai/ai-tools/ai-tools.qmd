...
[Anthropic](https://www.anthropic.com/) is another company developing LLM AI tools. Their main AI is called [Claude](https://www.anthropic.com/claude). As for ChatGPT, you can sign up to get a free account. It is apparently not as powerful as ChatGPT. However, it has one nice feature that the free versions of ChatGPT or Bing do not have, namely it lets you upload files. This is useful for data analysis tasks. I'll show an example of that in the [Explore data with AI](../ai-eda-R/ai-eda-R.qmd) unit. 
...
For instance, as you learned from Thomas Mock's video above, the [`chattr` R package](https://mlverse.github.io/chattr/) seems like another great way to use ChatGPT from within R. Unfortunately, as of this writing, I haven't been able to get it to work, OpenAI seems to refuse talking to it. If you have better luck, let me know.

I'm also aware of the [chatAI4R](https://kumes.github.io/chatAI4R/) R package, but haven't tried it yet.
