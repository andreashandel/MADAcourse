...
-   Think carefully about what exactly you want to have done and give the AI instructions that are as detailed as possible. This is often called **prompt engineering** these days. That's just a fancy word to mean that you should think carefully what you want the AI to do for you, and be as detailed and specific as possible when you ask it to do something.
